        ...
        <form method="post">
            ...
            <div class="lp-grid">
                ...
                <div class="lp-sidebar">
                    ...
                    <!-- Support the project: -->
                    <div class="lp-coffee-card">

    <div class="lp-coffee-top">

        <div class="lp-coffee-content">

            <h3>Buy Me a Chai ☕</h3>

            <p>Your support helps maintain and improve Launch Press while funding the development of WordPress plugins, developer tools, tutorials, and open-source projects for the community.</p>

        </div>

    </div>

    <a href="https://chai.technotizia.com/" target="_blank" class="lp-coffee-btn">
        Support the Project
    </a>
